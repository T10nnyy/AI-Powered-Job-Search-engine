...
client = genai.Client(api_key="AIzaSyCVTWp20p6w4tM7w0YuruFkJUw6aoorS28")
...
def parse_resume_with_gemini(text: str) -> Dict[str, Any]:
    ...
    try:
        ...
        prompt = f"""
        You are a professional resume parser. Given the following resume text, extract the information and format it according to the schema provided.
